...
class MSMarcoIntentChecker:
    ...
    async def check_intent(self, query: str, response: str) -> IntentResult:
        ...
        try:
            ...
            # NOTE: Callback flow detection is now handled at OV level via tool invocation,
            # not here via text patterns. OV bypasses this check entirely for callback flows.
